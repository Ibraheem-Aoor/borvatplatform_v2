...
<body>
    ...
    @php
        $shippment_details = $shippment->getShipmentDetails();
    @endphp
    <div class="parent">
        ...
        <div class="child" style="padding:5px !important;" style="border:1px solid #000;">
            <ul>
                <li>
                    {{ @$shippment_details['firstName'] . ' ' . @$shippment_details['surname'] }}
                </li>
                <li>
                    {{ @$shippment_details['company'] }}
                </li>
                <li>
                    {{ @$shippment_details['zipCode'] }} &nbsp; {{ @$shippment_details['city'] }}
                </li>
                <li>
                    {{ @$$shippment_details['countryCode'] }}
                </li>
            </ul>
        </div>
